...
const Developer = ({ animationName = 'idle', ...props }) => {
    ...
    const { animations: idleAnimations } = useFBX('/models/human/idle.fbx')
    const { animations: saluteAnimations } = useFBX('/models/human/salute.fbx')
    const { animations: clappingAnimations } = useFBX('/models/human/clapping.fbx')
    const { animations: victoryAnimations } = useFBX('/models/human/victory.fbx')
    ...
    return (
        <group {...props} dispose={null} scale={[3, 3, 3]} position={[0, -2.8, 0]} ref={group}>
